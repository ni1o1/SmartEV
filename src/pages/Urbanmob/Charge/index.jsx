...
import { Button, Col, Card, Row, Collapse, Slider, Tooltip } from 'antd';
import {
    InfoCircleOutlined
...
*/
    ...
    useEffect(() => {
        ...
        if (charged_power.length > 0) {
            ...
            if (selected_area.features.length > 0) {
                ...
                charged_power_selected = charged_power
            }
            //集计
        ...
        if (potential_power.length > 0) {
            ...
            if (selected_area.features.length > 0) {
                ...
                potential_power_selected = potential_power
            }
            //集计
    ...
    return (
        <>
            <Col span={24}>
                <Card title="充电需求" extra={<Tooltip title='Click on the bars to show trajectories.'><InfoCircleOutlined /></Tooltip>}
                    bordered={false}>
                    <Collapse defaultActiveKey={['Trajectory-Echarts-1']}>
                        <Panel header="充电需求分析" key="Trajectory-Echarts-1">
                            <Button onClick={CreateArea}>选择区域</Button>
                            {/* <Button onClick={ClearArea} >清除区域</Button> */}
                            <ReactECharts
                                option={option}
                                notMerge={true}
